...
Tesseract4Delphi was developed and tested on Delphi 13.1, Delphi 6 and Lazarus 4.4/FPC 3.2.2. 
...
* **Windows:** The _bin32_ and _bin64_ directories contain the Windows binaries of Tesseract 5.5.3. It's required to install the Microsoft Visual C++ 2017 Redistributable package [available here](https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170#latest-supported-redistributable-version).
